window.teams = [
    {
        ...
        description: "Es el equipo con la hinchada mas alocada, polemico por sus contactos indevidos con otros equipos",
        ...
        championships: [
            ...
            { name: "Copa 1102", result: "FC Domo 1 -  0 Alianza Meneses", note: "En tiempo extra" }
        ],
        runnerUps: [
            { name: "Copa 1102", result: "FC Domo 2 (3) - (4) 2 United Andres ", note: "Creo que fue por penales (No me acuerdo)" },
            { name: "Copa 1102", result: "FC Domo 0 - 2 Cristian FC ", note: "No me acuerdo, para llenar" },
        ],
        thirdPlaces: [
            { name: "Copa 1102", note: "-" }
        ]
    },
    {
        ...
        description: "Siempre se clasifica, nunca gana, hijo eterno del deportivo Murillo.",
    ...
    },
    {
        ...
        description: "Es el equipo mas grande del torneo, lleno de mistica y gloria, su palmares no hace honor a su mistica",
        ...
        runnerUps: [],
        thirdPlaces: [
            { name: "Copa 1102", result: "Deportivo Virsa 3 - United Andres 0", note: "NO te presentaste por cagon!" }
        ]
    },
    {
        id: "United_Andres",
        ...
        description: "Es uno de los equipos mas fuertes del torneo, siempre candidato a ganar la copa, pero la mala suerte siempre esta con ellos.",
        ...
        championships: [
            { name: "Copa 1102", result: "United Andres 2 (4) - (3) 2 FC Domo", note: "Creo que fue por penales (No me acuerdo)" }
        ],
        runnerUps: [
    ...
    },
    {
        ...
        championships: [],
        runnerUps: [
            { name: "Copa 1102", result: "Inter Gerrard 0 - 2 FC Domo ", note: "mlp Salah" }
        ],
        thirdPlaces: []
    },
    {
    ...
    },
    {
        ...
        championships: [
            { name: "Copa 1102", result: "Cristian FC 1 - 0 United Andres", note: "No me acuerdo es un resultado para llenar" },
            { name: "Copa 1102", result: "Cristian FC 2 - 0 FC Domo", note: "No me acuerdo es un resultado para llenar" },
            { name: "Copa 1102", result: "Cristian FC 1 - 0 United Andres", note: "No me acuerdo es un resultado para llenar" },
        ],
        runnerUps: [
            { name: "Copa 1102", result: "Cristian FC 1 - 2 AC Cagua", note: "Batacazo" },
            { name: "Copa 1102", result: "Cristian FC 0 - 1 Alianza Meneses", note: "No me acuerdo es un resultado para llenar" }
        ],
        thirdPlaces: []
    },
    {
    ...
    },
    {
        ...
        runnerUps: [
            { name: "Copa 1102", result: "Alianza Meneses 0 - 1 FC Domo", note: "En tiempo extra" }
        ],
        thirdPlaces: []
    },
];
